...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<!-- Favicons -->
  <link rel="apple-touch-icon" sizes="180x180" href="<?php bloginfo('template_directory') ?>/public/favicon/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php bloginfo('template_directory') ?>/public/favicon/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php bloginfo('template_directory') ?>/public/favicon/favicon-16x16.png">
  <link rel="manifest" href="<?php bloginfo('template_directory') ?>/public/site.webmanifest">
  <meta name="yandex-tableau-widget" content="logo=<?php bloginfo('template_directory') ?>/public/favicon/yandex-tab-icon.png, color=#dc2229">
  <link rel="mask-icon" href="<?php bloginfo('template_directory') ?>/public/favicon/safari-pinned-tab.svg" color="#dc2229">
  <meta name="msapplication-name" content="#dc2229">
  <meta name="msapplication-TileColor" content="<?php bloginfo('template_directory') ?>/public/favicon/mstile-144x144.png">
  <meta name="theme-color" content="#dc2229">
	<!-- Google Analytics -->
	<script async src="//www.googletagmanager.com/gtag/js?id=UA-122315342-1"></script>
	<script>window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'UA-122315342-1');</script>
	<!-- Fonts -->
