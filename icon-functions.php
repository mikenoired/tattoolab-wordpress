...
// Return SVG markup
function tattoolab_get_svg($args = array())
{
  ...
  // Begin SVG markup.
  $svg = '<svg fill="#ffffff" class="icon icon-' . esc_attr($args['icon']) . '"' . $aria_hidden . $aria_labelledby . ' role="img">';
 ...
 */
function tattoolab_nav_menu_social_icons($item_output, $item, $depth, $args)
{
  // Get supported social icons.
  $social_icons = tattoolab_social_links_icons();
...
add_filter('walker_nav_menu_start_el', 'tattoolab_nav_menu_social_icons', 10, 4);
 ...
 */
function tattoolab_social_links_icons()
{
  ...
  /**
   * Filter Tattoolab social links icons.
   *
